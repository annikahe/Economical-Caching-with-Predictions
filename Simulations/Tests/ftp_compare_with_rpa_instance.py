...
if __name__ == '__main__':
    ...
    num_reps = 10  # how often we run one iteration with fixed inputs
    num_gens = 100  # how often we generate new inputs
    ...
    for p in phi_list:
        if treatment == 'cr':
            base.evaluate_error_ratio(quality_of_FtP_phi_ratio, treatments_input, treatments_predictions, num_gens,
                                      num_reps, input_len, p, "FtP-quality")
